...
Project 4 - Group 2 
Predicting Glacier Change in Alaska with Machine Learning 
...
7.	Save the results in a dataframe named SMLprep with the following columns: Id', 'Name', 'Lat',' Lon',' Area (mi^2)_1985', 'Area (mi^2)_2020', 'Area Shrinkage (mi^2)', 'Shrinkage', 'Height (ft)', 'Length (ft)'.
...
7. Render your map using the Layout Loader plug-in. 
8. Add a title and a legend to the map.
9. Save the map to your local directory as an image from the Layout tab. 
